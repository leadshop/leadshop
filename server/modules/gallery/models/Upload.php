...
class Upload
{
     ...
     */
    public function image_base64($base64_img)
    {
     ...
     * @return [type]              [description]
     */
    public function image_compress($image_url, $width = 500, $height = 0)
    {
        $size = filesize(self::$root_path . '/web' . $image_url);
        if ($size > self::$compress_start) {
